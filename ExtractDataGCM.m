% EXTRACTDATAGCM Extract GCM/RCM data on equal interval lon-lat grid to csv
% 
% ExtractDataGCM(inputdir, outdir, bbox, startdate, var, multiplier,
...
% 
% Example:
%   ExtractDataGCM(inputdir, outdir, [87, 93, 20, 26], '1860-1-1', 'pr', 86400, 0)

function [status] = ExtractDataGCM(inputdir, outdir, bbox, startdate, var, multiplier, addition)
...
outfile = fullfile(outdir, [outfile '.csv']); 
